...
public class ItemRegistry {
    ...
    public static final RegistrySupplier<Item> ADAMANTIUM_IMPERVIUM_HELMET          = registerArmorItem("adamantium_impervium_helmet",          ArmorMaterialRegistry.LAB,                     ArmorItem.Type.HELMET,      40);
    public static final RegistrySupplier<Item> ADAMANTIUM_IMPERVIUM_CHESTPLATE      = registerArmorItem("adamantium_impervium_chestplate",      ArmorMaterialRegistry.LAB,                     ArmorItem.Type.CHESTPLATE,  40);
    public static final RegistrySupplier<Item> ADAMANTIUM_IMPERVIUM_LEGGINGS        = registerArmorItem("adamantium_impervium_leggings",        ArmorMaterialRegistry.LAB,                     ArmorItem.Type.LEGGINGS,    40);
    public static final RegistrySupplier<Item> ADAMANTIUM_IMPERVIUM_BOOTS           = registerArmorItem("adamantium_impervium_boots",           ArmorMaterialRegistry.LAB,                     ArmorItem.Type.BOOTS,       40);

    public static final RegistrySupplier<Item> ADMIN_FRED_HELMET                    = registerArmorItem("admin_fred_helmet",                    ArmorMaterialRegistry.CHAMPION,                ArmorItem.Type.HELMET,      0);
    public static final RegistrySupplier<Item> ADMIN_FRED_CHESTPLATE                = registerArmorItem("admin_fred_chestplate",                ArmorMaterialRegistry.CHAMPION,                ArmorItem.Type.CHESTPLATE,  0);
    public static final RegistrySupplier<Item> ADMIN_FRED_LEGGINGS                  = registerArmorItem("admin_fred_leggings",                  ArmorMaterialRegistry.CHAMPION,                ArmorItem.Type.LEGGINGS,    0);
    public static final RegistrySupplier<Item> ADMIN_FRED_BOOTS                     = registerArmorItem("admin_fred_boots",                     ArmorMaterialRegistry.CHAMPION,                ArmorItem.Type.BOOTS,       0);

    public static final RegistrySupplier<Item> ADMIN_ROMEO_HELMET                   = registerArmorItem("admin_romeo_helmet",                   ArmorMaterialRegistry.CHAMPION,                ArmorItem.Type.HELMET,      0);
    public static final RegistrySupplier<Item> ADMIN_ROMEO_CHESTPLATE               = registerArmorItem("admin_romeo_chestplate",               ArmorMaterialRegistry.CHAMPION,                ArmorItem.Type.CHESTPLATE,  0);
    public static final RegistrySupplier<Item> ADMIN_ROMEO_LEGGINGS                 = registerArmorItem("admin_romeo_leggings",                 ArmorMaterialRegistry.CHAMPION,                ArmorItem.Type.LEGGINGS,    0);
    public static final RegistrySupplier<Item> ADMIN_ROMEO_BOOTS                    = registerArmorItem("admin_romeo_boots",                    ArmorMaterialRegistry.CHAMPION,                ArmorItem.Type.BOOTS,       0);

    public static final RegistrySupplier<Item> ADMIN_XARA_HELMET                    = registerArmorItem("admin_xara_helmet",                    ArmorMaterialRegistry.CHAMPION,                ArmorItem.Type.HELMET,      0);
    public static final RegistrySupplier<Item> ADMIN_XARA_CHESTPLATE                = registerArmorItem("admin_xara_chestplate",                ArmorMaterialRegistry.CHAMPION,                ArmorItem.Type.CHESTPLATE,  0);
    public static final RegistrySupplier<Item> ADMIN_XARA_LEGGINGS                  = registerArmorItem("admin_xara_leggings",                  ArmorMaterialRegistry.CHAMPION,                ArmorItem.Type.LEGGINGS,    0);
    public static final RegistrySupplier<Item> ADMIN_XARA_BOOTS                     = registerArmorItem("admin_xara_boots",                     ArmorMaterialRegistry.CHAMPION,                ArmorItem.Type.BOOTS,       0);
    ...
    public static final RegistrySupplier<Item> AXEL_HELMET                          = registerArmorItem("axel_helmet",                          ArmorMaterialRegistry.ORDER_OF_THE_STONE,      ArmorItem.Type.HELMET,      0);
    public static final RegistrySupplier<Item> AXEL_CHESTPLATE                      = registerArmorItem("axel_chestplate",                      ArmorMaterialRegistry.ORDER_OF_THE_STONE,      ArmorItem.Type.CHESTPLATE,  0);
    public static final RegistrySupplier<Item> AXEL_LEGGINGS                        = registerArmorItem("axel_leggings",                        ArmorMaterialRegistry.ORDER_OF_THE_STONE,      ArmorItem.Type.LEGGINGS,    0);
    public static final RegistrySupplier<Item> AXEL_BOOTS                           = registerArmorItem("axel_boots",                           ArmorMaterialRegistry.ORDER_OF_THE_STONE,      ArmorItem.Type.BOOTS,       0);

    public static final RegistrySupplier<Item> CHAMPION_JACK_HELMET                 = registerArmorItem("champion_jack_helmet",                 ArmorMaterialRegistry.CHAMPION,                ArmorItem.Type.HELMET,      0);
    public static final RegistrySupplier<Item> CHAMPION_JACK_CHESTPLATE             = registerArmorItem("champion_jack_chestplate",             ArmorMaterialRegistry.CHAMPION,                ArmorItem.Type.CHESTPLATE,  0);
    public static final RegistrySupplier<Item> CHAMPION_JACK_LEGGINGS               = registerArmorItem("champion_jack_leggings",               ArmorMaterialRegistry.CHAMPION,                ArmorItem.Type.LEGGINGS,    0);
    public static final RegistrySupplier<Item> CHAMPION_JACK_BOOTS                  = registerArmorItem("champion_jack_boots",                  ArmorMaterialRegistry.CHAMPION,                ArmorItem.Type.BOOTS,       0);

    public static final RegistrySupplier<Item> CHAMPION_PETRA_HELMET                = registerArmorItem("champion_petra_helmet",                ArmorMaterialRegistry.CHAMPION,                ArmorItem.Type.HELMET,      37);
    public static final RegistrySupplier<Item> CHAMPION_PETRA_CHESTPLATE            = registerArmorItem("champion_petra_chestplate",            ArmorMaterialRegistry.CHAMPION,                ArmorItem.Type.CHESTPLATE,  37);
    public static final RegistrySupplier<Item> CHAMPION_PETRA_LEGGINGS              = registerArmorItem("champion_petra_leggings",              ArmorMaterialRegistry.CHAMPION,                ArmorItem.Type.LEGGINGS,    37);
    public static final RegistrySupplier<Item> CHAMPION_PETRA_BOOTS                 = registerArmorItem("champion_petra_boots",                 ArmorMaterialRegistry.CHAMPION,                ArmorItem.Type.BOOTS,       37);
    ...
    public static final RegistrySupplier<Item> DRAGONSBANE_HELMET                   = registerArmorItem("dragonsbane_helmet",                   ArmorMaterialRegistry.LAB,                     ArmorItem.Type.HELMET,      0);
    public static final RegistrySupplier<Item> DRAGONSBANE_CHESTPLATE               = registerArmorItem("dragonsbane_chestplate",               ArmorMaterialRegistry.LAB,                     ArmorItem.Type.CHESTPLATE,  0);
    public static final RegistrySupplier<Item> DRAGONSBANE_LEGGINGS                 = registerArmorItem("dragonsbane_leggings",                 ArmorMaterialRegistry.LAB,                     ArmorItem.Type.LEGGINGS,    0);
    public static final RegistrySupplier<Item> DRAGONSBANE_BOOTS                    = registerArmorItem("dragonsbane_boots",                    ArmorMaterialRegistry.LAB,                     ArmorItem.Type.BOOTS,       0);

    public static final RegistrySupplier<Item> ELLEGAARD_HELMET                     = registerArmorItem("ellegaard_helmet",                     ArmorMaterialRegistry.ORDER_OF_THE_STONE,      ArmorItem.Type.HELMET,      0);
    public static final RegistrySupplier<Item> ELLEGAARD_CHESTPLATE                 = registerArmorItem("ellegaard_chestplate",                 ArmorMaterialRegistry.ORDER_OF_THE_STONE,      ArmorItem.Type.CHESTPLATE,  0);
    public static final RegistrySupplier<Item> ELLEGAARD_LEGGINGS                   = registerArmorItem("ellegaard_leggings",                   ArmorMaterialRegistry.ORDER_OF_THE_STONE,      ArmorItem.Type.LEGGINGS,    0);
    public static final RegistrySupplier<Item> ELLEGAARD_BOOTS                      = registerArmorItem("ellegaard_boots",                      ArmorMaterialRegistry.ORDER_OF_THE_STONE,      ArmorItem.Type.BOOTS,       0);

    public static final RegistrySupplier<Item> ENDER_DEFENDER_HELMET                = registerArmorItem("ender_defender_helmet",                ArmorMaterialRegistry.LAB,                     ArmorItem.Type.HELMET,      0);
    public static final RegistrySupplier<Item> ENDER_DEFENDER_CHESTPLATE            = registerArmorItem("ender_defender_chestplate",            ArmorMaterialRegistry.LAB,                     ArmorItem.Type.CHESTPLATE,  0);
    public static final RegistrySupplier<Item> ENDER_DEFENDER_LEGGINGS              = registerArmorItem("ender_defender_leggings",              ArmorMaterialRegistry.LAB,                     ArmorItem.Type.LEGGINGS,    0);
    public static final RegistrySupplier<Item> ENDER_DEFENDER_BOOTS                 = registerArmorItem("ender_defender_boots",                 ArmorMaterialRegistry.LAB,                     ArmorItem.Type.BOOTS,       0);

    public static final RegistrySupplier<Item> ENDERMAN_HELMET                      = registerArmorItem("enderman_helmet",                      ArmorMaterialRegistry.ENDERMAN,                ArmorItem.Type.HELMET,      0);
    public static final RegistrySupplier<Item> ENDERMAN_CHESTPLATE                  = registerArmorItem("enderman_chestplate",                  ArmorMaterialRegistry.ENDERMAN,                ArmorItem.Type.CHESTPLATE,  0);
    public static final RegistrySupplier<Item> ENDERMAN_LEGGINGS                    = registerArmorItem("enderman_leggings",                    ArmorMaterialRegistry.ENDERMAN,                ArmorItem.Type.LEGGINGS,    0);
    public static final RegistrySupplier<Item> ENDERMAN_BOOTS                       = registerArmorItem("enderman_boots",                       ArmorMaterialRegistry.ENDERMAN,                ArmorItem.Type.BOOTS,       0);
    ...
    public static final RegistrySupplier<Item> GABRIEL_HELMET                       = registerArmorItem("gabriel_helmet",                       ArmorMaterialRegistry.ORDER_OF_THE_STONE,      ArmorItem.Type.HELMET,      0);
    public static final RegistrySupplier<Item> GABRIEL_CHESTPLATE                   = registerArmorItem("gabriel_chestplate",                   ArmorMaterialRegistry.ORDER_OF_THE_STONE,      ArmorItem.Type.CHESTPLATE,  0);
    public static final RegistrySupplier<Item> GABRIEL_LEGGINGS                     = registerArmorItem("gabriel_leggings",                     ArmorMaterialRegistry.ORDER_OF_THE_STONE,      ArmorItem.Type.LEGGINGS,    0);
    public static final RegistrySupplier<Item> GABRIEL_BOOTS                        = registerArmorItem("gabriel_boots",                        ArmorMaterialRegistry.ORDER_OF_THE_STONE,      ArmorItem.Type.BOOTS,       0);
    ...
    public static final RegistrySupplier<Item> GOLDEN_GOLIATH_HELMET                = registerArmorItem("golden_goliath_helmet",                ArmorMaterialRegistry.LAB,                     ArmorItem.Type.HELMET,      0);
    public static final RegistrySupplier<Item> GOLDEN_GOLIATH_CHESTPLATE            = registerArmorItem("golden_goliath_chestplate",            ArmorMaterialRegistry.LAB,                     ArmorItem.Type.CHESTPLATE,  0);
    public static final RegistrySupplier<Item> GOLDEN_GOLIATH_LEGGINGS              = registerArmorItem("golden_goliath_leggings",              ArmorMaterialRegistry.LAB,                     ArmorItem.Type.LEGGINGS,    0);
    public static final RegistrySupplier<Item> GOLDEN_GOLIATH_BOOTS                 = registerArmorItem("golden_goliath_boots",                 ArmorMaterialRegistry.LAB,                     ArmorItem.Type.BOOTS,       0);

    public static final RegistrySupplier<Item> GOLDEN_GOLIATH_CIRCUITRY_HELMET      = registerArmorItem("golden_goliath_circuitry_helmet",      ArmorMaterialRegistry.LAB,                     ArmorItem.Type.HELMET,      0);
    public static final RegistrySupplier<Item> GOLDEN_GOLIATH_CIRCUITRY_CHESTPLATE  = registerArmorItem("golden_goliath_circuitry_chestplate",  ArmorMaterialRegistry.LAB,                     ArmorItem.Type.CHESTPLATE,  0);
    public static final RegistrySupplier<Item> GOLDEN_GOLIATH_CIRCUITRY_LEGGINGS    = registerArmorItem("golden_goliath_circuitry_leggings",    ArmorMaterialRegistry.LAB,                     ArmorItem.Type.LEGGINGS,    0);
    public static final RegistrySupplier<Item> GOLDEN_GOLIATH_CIRCUITRY_BOOTS       = registerArmorItem("golden_goliath_circuitry_boots",       ArmorMaterialRegistry.LAB,                     ArmorItem.Type.BOOTS,       0);
    ...
    public static final RegistrySupplier<Item> IVOR_HELMET                          = registerArmorItem("ivor_helmet",                          ArmorMaterialRegistry.ORDER_OF_THE_STONE,      ArmorItem.Type.HELMET,      0);
    public static final RegistrySupplier<Item> IVOR_CHESTPLATE                      = registerArmorItem("ivor_chestplate",                      ArmorMaterialRegistry.ORDER_OF_THE_STONE,      ArmorItem.Type.CHESTPLATE,  0);
    public static final RegistrySupplier<Item> IVOR_LEGGINGS                        = registerArmorItem("ivor_leggings",                        ArmorMaterialRegistry.ORDER_OF_THE_STONE,      ArmorItem.Type.LEGGINGS,    0);
    public static final RegistrySupplier<Item> IVOR_BOOTS                           = registerArmorItem("ivor_boots",                           ArmorMaterialRegistry.ORDER_OF_THE_STONE,      ArmorItem.Type.BOOTS,       0);
    ...
    public static final RegistrySupplier<Item> LUKAS_HELMET                         = registerArmorItem("lukas_helmet",                         ArmorMaterialRegistry.ORDER_OF_THE_STONE,      ArmorItem.Type.HELMET,      0);
    public static final RegistrySupplier<Item> LUKAS_CHESTPLATE                     = registerArmorItem("lukas_chestplate",                     ArmorMaterialRegistry.ORDER_OF_THE_STONE,      ArmorItem.Type.CHESTPLATE,  0);
    public static final RegistrySupplier<Item> LUKAS_LEGGINGS                       = registerArmorItem("lukas_leggings",                       ArmorMaterialRegistry.ORDER_OF_THE_STONE,      ArmorItem.Type.LEGGINGS,    0);
    public static final RegistrySupplier<Item> LUKAS_BOOTS                          = registerArmorItem("lukas_boots",                          ArmorMaterialRegistry.ORDER_OF_THE_STONE,      ArmorItem.Type.BOOTS,       0);

    public static final RegistrySupplier<Item> MAGNUS_HELMET                        = registerArmorItem("magnus_helmet",                        ArmorMaterialRegistry.ORDER_OF_THE_STONE,      ArmorItem.Type.HELMET,      0);
    public static final RegistrySupplier<Item> MAGNUS_CHESTPLATE                    = registerArmorItem("magnus_chestplate",                    ArmorMaterialRegistry.ORDER_OF_THE_STONE,      ArmorItem.Type.CHESTPLATE,  0);
    public static final RegistrySupplier<Item> MAGNUS_LEGGINGS                      = registerArmorItem("magnus_leggings",                      ArmorMaterialRegistry.ORDER_OF_THE_STONE,      ArmorItem.Type.LEGGINGS,    0);
    public static final RegistrySupplier<Item> MAGNUS_BOOTS                         = registerArmorItem("magnus_boots",                         ArmorMaterialRegistry.ORDER_OF_THE_STONE,      ArmorItem.Type.BOOTS,       0);
    ...
    public static final RegistrySupplier<Item> NINJA_HELMET                         = registerArmorItem("ninja_helmet",                         ArmorMaterialRegistry.NINJA_ARMOR,             ArmorItem.Type.HELMET,      0);
    public static final RegistrySupplier<Item> NINJA_CHESTPLATE                     = registerArmorItem("ninja_chestplate",                     ArmorMaterialRegistry.NINJA_ARMOR,             ArmorItem.Type.CHESTPLATE,  0);
    public static final RegistrySupplier<Item> NINJA_LEGGINGS                       = registerArmorItem("ninja_leggings",                       ArmorMaterialRegistry.NINJA_ARMOR,             ArmorItem.Type.LEGGINGS,    0);
    public static final RegistrySupplier<Item> NINJA_BOOTS                          = registerArmorItem("ninja_boots",                          ArmorMaterialRegistry.NINJA_ARMOR,             ArmorItem.Type.BOOTS,       0);
    ...
    public static final RegistrySupplier<Item> OLIVIA_HELMET                        = registerArmorItem("olivia_helmet",                        ArmorMaterialRegistry.ORDER_OF_THE_STONE,      ArmorItem.Type.HELMET,      0);
    public static final RegistrySupplier<Item> OLIVIA_CHESTPLATE                    = registerArmorItem("olivia_chestplate",                    ArmorMaterialRegistry.ORDER_OF_THE_STONE,      ArmorItem.Type.CHESTPLATE,  0);
    public static final RegistrySupplier<Item> OLIVIA_LEGGINGS                      = registerArmorItem("olivia_leggings",                      ArmorMaterialRegistry.ORDER_OF_THE_STONE,      ArmorItem.Type.LEGGINGS,    0);
    public static final RegistrySupplier<Item> OLIVIA_BOOTS                         = registerArmorItem("olivia_boots",                         ArmorMaterialRegistry.ORDER_OF_THE_STONE,      ArmorItem.Type.BOOTS,       0);

    public static final RegistrySupplier<Item> PETRA_HELMET                         = registerArmorItem("petra_helmet",                         ArmorMaterialRegistry.ORDER_OF_THE_STONE,      ArmorItem.Type.HELMET,      0);
    public static final RegistrySupplier<Item> PETRA_CHESTPLATE                     = registerArmorItem("petra_chestplate",                     ArmorMaterialRegistry.ORDER_OF_THE_STONE,      ArmorItem.Type.CHESTPLATE,  0);
    public static final RegistrySupplier<Item> PETRA_LEGGINGS                       = registerArmorItem("petra_leggings",                       ArmorMaterialRegistry.ORDER_OF_THE_STONE,      ArmorItem.Type.LEGGINGS,    0);
    public static final RegistrySupplier<Item> PETRA_BOOTS                          = registerArmorItem("petra_boots",                          ArmorMaterialRegistry.ORDER_OF_THE_STONE,      ArmorItem.Type.BOOTS,       0);
    ...
    public static final RegistrySupplier<Item> PRISMARINE_SOLDIER_HELMET            = registerArmorItem("prismarine_soldier_helmet",            ArmorMaterialRegistry.PRISMARINE,              ArmorItem.Type.HELMET,      0);
    public static final RegistrySupplier<Item> PRISMARINE_SOLDIER_CHESTPLATE        = registerArmorItem("prismarine_soldier_chestplate",        ArmorMaterialRegistry.PRISMARINE,              ArmorItem.Type.CHESTPLATE,  0);
    public static final RegistrySupplier<Item> PRISMARINE_SOLDIER_LEGGINGS          = registerArmorItem("prismarine_soldier_leggings",          ArmorMaterialRegistry.PRISMARINE,              ArmorItem.Type.LEGGINGS,    0);
    public static final RegistrySupplier<Item> PRISMARINE_SOLDIER_BOOTS             = registerArmorItem("prismarine_soldier_boots",             ArmorMaterialRegistry.PRISMARINE,              ArmorItem.Type.BOOTS,       0);

    public static final RegistrySupplier<Item> REDSTONE_RIOT_HELMET                 = registerArmorItem("redstone_riot_helmet",                 ArmorMaterialRegistry.LAB,                     ArmorItem.Type.HELMET,      0);
    public static final RegistrySupplier<Item> REDSTONE_RIOT_CHESTPLATE             = registerArmorItem("redstone_riot_chestplate",             ArmorMaterialRegistry.LAB,                     ArmorItem.Type.CHESTPLATE,  0);
    public static final RegistrySupplier<Item> REDSTONE_RIOT_LEGGINGS               = registerArmorItem("redstone_riot_leggings",               ArmorMaterialRegistry.LAB,                     ArmorItem.Type.LEGGINGS,    0);
    public static final RegistrySupplier<Item> REDSTONE_RIOT_BOOTS                  = registerArmorItem("redstone_riot_boots",                  ArmorMaterialRegistry.LAB,                     ArmorItem.Type.BOOTS,       0);
    ...
    public static final RegistrySupplier<Item> SHIELD_OF_INFINITY_HELMET            = registerArmorItem("shield_of_infinity_helmet",            ArmorMaterialRegistry.LAB,                     ArmorItem.Type.HELMET,      0);
    public static final RegistrySupplier<Item> SHIELD_OF_INFINITY_CHESTPLATE        = registerArmorItem("shield_of_infinity_chestplate",        ArmorMaterialRegistry.LAB,                     ArmorItem.Type.CHESTPLATE,  0);
    public static final RegistrySupplier<Item> SHIELD_OF_INFINITY_LEGGINGS          = registerArmorItem("shield_of_infinity_leggings",          ArmorMaterialRegistry.LAB,                     ArmorItem.Type.LEGGINGS,    0);
    public static final RegistrySupplier<Item> SHIELD_OF_INFINITY_BOOTS             = registerArmorItem("shield_of_infinity_boots",             ArmorMaterialRegistry.LAB,                     ArmorItem.Type.BOOTS,       0);
    ...
    public static final RegistrySupplier<Item> SOREN_HELMET                         = registerArmorItem("soren_helmet",                         ArmorMaterialRegistry.ORDER_OF_THE_STONE,      ArmorItem.Type.HELMET,      0);
    public static final RegistrySupplier<Item> SOREN_CHESTPLATE                     = registerArmorItem("soren_chestplate",                     ArmorMaterialRegistry.ORDER_OF_THE_STONE,      ArmorItem.Type.CHESTPLATE,  0);
    public static final RegistrySupplier<Item> SOREN_LEGGINGS                       = registerArmorItem("soren_leggings",                       ArmorMaterialRegistry.ORDER_OF_THE_STONE,      ArmorItem.Type.LEGGINGS,    0);
    public static final RegistrySupplier<Item> SOREN_BOOTS                          = registerArmorItem("soren_boots",                          ArmorMaterialRegistry.ORDER_OF_THE_STONE,      ArmorItem.Type.BOOTS,       0);

    public static final RegistrySupplier<Item> STAR_SHIELD_HELMET                   = registerArmorItem("star_shield_helmet",                   ArmorMaterialRegistry.LAB,                     ArmorItem.Type.HELMET,      0);
    public static final RegistrySupplier<Item> STAR_SHIELD_CHESTPLATE               = registerArmorItem("star_shield_chestplate",               ArmorMaterialRegistry.LAB,                     ArmorItem.Type.CHESTPLATE,  0);
    public static final RegistrySupplier<Item> STAR_SHIELD_LEGGINGS                 = registerArmorItem("star_shield_leggings",                 ArmorMaterialRegistry.LAB,                     ArmorItem.Type.LEGGINGS,    0);
    public static final RegistrySupplier<Item> STAR_SHIELD_BOOTS                    = registerArmorItem("star_shield_boots",                    ArmorMaterialRegistry.LAB,                     ArmorItem.Type.BOOTS,       0);
    ...
    public static final RegistrySupplier<Item> SWORDBREAKER_HELMET                  = registerArmorItem("swordbreaker_helmet",                  ArmorMaterialRegistry.LAB,                     ArmorItem.Type.HELMET,      0);
    public static final RegistrySupplier<Item> SWORDBREAKER_CHESTPLATE              = registerArmorItem("swordbreaker_chestplate",              ArmorMaterialRegistry.LAB,                     ArmorItem.Type.CHESTPLATE,  0);
    public static final RegistrySupplier<Item> SWORDBREAKER_LEGGINGS                = registerArmorItem("swordbreaker_leggings",                ArmorMaterialRegistry.LAB,                     ArmorItem.Type.LEGGINGS,    0);
    public static final RegistrySupplier<Item> SWORDBREAKER_BOOTS                   = registerArmorItem("swordbreaker_boots",                   ArmorMaterialRegistry.LAB,                     ArmorItem.Type.BOOTS,       0);
    ...
    public static final RegistrySupplier<Item> WHITE_PUMPKIN_HELMET                 = registerArmorItem("white_pumpkin_helmet",                 ArmorMaterialRegistry.WHITE_PUMPKIN,           ArmorItem.Type.HELMET,      0);
    public static final RegistrySupplier<Item> WHITE_PUMPKIN_CHESTPLATE             = registerArmorItem("white_pumpkin_chestplate",             ArmorMaterialRegistry.WHITE_PUMPKIN,           ArmorItem.Type.CHESTPLATE,  0);
    public static final RegistrySupplier<Item> WHITE_PUMPKIN_LEGGINGS               = registerArmorItem("white_pumpkin_leggings",               ArmorMaterialRegistry.WHITE_PUMPKIN,           ArmorItem.Type.LEGGINGS,    0);
    public static final RegistrySupplier<Item> WHITE_PUMPKIN_BOOTS                  = registerArmorItem("white_pumpkin_boots",                  ArmorMaterialRegistry.WHITE_PUMPKIN,           ArmorItem.Type.BOOTS,       0);
