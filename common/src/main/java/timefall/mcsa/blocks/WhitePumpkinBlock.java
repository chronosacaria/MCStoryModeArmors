...
public class WhitePumpkinBlock extends GourdBlock {
    ...
    public ActionResult onUse(BlockState state, World world, BlockPos pos, PlayerEntity player, Hand hand, BlockHitResult hit) {
        ...
        if (itemStack.isOf(Items.SHEARS)) {
            if (!world.isClient) {
                ...
                world.setBlockState(pos,BlocksInit.CARVED_WHITE_PUMPKIN_BLOCK.get().getDefaultState().with(CarvedPumpkinBlock.FACING, direction2), 11);
